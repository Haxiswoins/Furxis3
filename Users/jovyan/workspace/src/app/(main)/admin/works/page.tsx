...
import { deleteWork, getWorks } from '@/lib/data-service';
import type { Work } from '@/types';
import { useToast } from '@/hooks/use-toast';
import Image from 'next/image';
import { Skeleton } from '@/components/ui/skeleton';

function AdminWorksPageSkeleton() {
    return (
        <div>
  ...
  useEffect(() => {
    async function fetchData() {
        ...
        try {
            ...
            toast({ title: '加载失败', description: '无法从服务器获取作品数据。', variant: 'destructive' });
        } finally {
            setLoading(false);
        }
    }
