...
import { saveSiteContent } from '@/lib/data-service';
...
export default function ContentClientPage({ initialContent }: ContentClientPageProps) {
    ...
    const [commissionImagePreview, setCommissionImagePreview] = useState<string | null>(initialContent?.commissionImageUrl || null);
    const [adoptionImagePreview, setAdoptionImagePreview] = useState<string | null>(initialContent?.adoptionImageUrl || null);
    const [workImagePreview, setWorkImagePreview] = useState<string | null>(initialContent?.workImageUrl || null);
    ...
    const handleSave = async (values: FormValues) => {
        setLoading(true);
        try {
            let newCommissionImageUrl = values.commissionImageUrl || initialContent?.commissionImageUrl;
            let newAdoptionImageUrl = values.adoptionImageUrl || initialContent?.adoptionImageUrl;
            let newWorkImageUrl = values.workImageUrl || initialContent?.workImageUrl;
