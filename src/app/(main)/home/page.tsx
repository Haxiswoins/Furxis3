...
export default function HomePage() {
  ...
  useEffect(() => {
    // This timer ensures that the animation only runs after the component is mounted on the client.
    // It prevents the "flash" of content by delaying the transition slightly.
