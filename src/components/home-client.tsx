...
export function HomeClient({ content }: HomeClientProps) {
  ...
  const cardTextDivClass = "absolute inset-0 flex flex-col justify-end p-6 md:p-8 text-white bg-gradient-to-t from-black/50 via-black/20 via-25% to-transparent to-40% transition-all duration-500 ease-in-out";
